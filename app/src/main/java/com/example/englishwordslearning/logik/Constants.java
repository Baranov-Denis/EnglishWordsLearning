...
public class Constants {
   ...
   // public static final String LIST_OF_TABLES_NAMES = "sqlite_sequence";
    ...
    public static final String COLUMN_WHERE_CONTAINS_TABLES_NAMES = "TABLE_NAME";
   // public static final String COLUMN_WHERE_CONTAINS_TABLES_NAMES = "name";
    public static final int DB_VERSION_FOR_UPDATE = 2;
}
